...
module.exports = (client, inter) => {
    ...
    if (!command) return inter.reply({ embeds: [ new EmbedBuilder().setColor('#ff0000').setDescription('❌ | Error! Please contact JiramDevelopers!')], ephemeral: true, }), client.slash.delete(inter.commandName)

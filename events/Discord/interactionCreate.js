...
module.exports = async (client, inter) => {
    ...
    if (!command) return inter.editReply({ embeds: [ new EmbedBuilder().setColor('#ff0000').setDescription('❌ | Error! Please contact JiramDevelopers!')], ephemeral: true, }), client.slash.delete(inter.commandName)
